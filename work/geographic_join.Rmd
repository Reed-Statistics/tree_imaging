...
```{r}
# save results
#write.csv(poly_join_reprojected,'poly_join_reprojected1.csv', row.names = F)
poly_join_reprojected <- read.csv('poly_join_reprojected1.csv')
#write.csv(val_combined,'val_combined1.csv', row.names = F)
...
#write.csv(pixels_data,'pixels_data.csv', row.names = F)
```
