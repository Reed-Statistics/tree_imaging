...
# (r_matches == 1)/((r_matches == 0) + (r_matches == 1)) percentage in common
...
plot(m_RF, main = "RF C = 5 with pdxTrees", 
     labels = F, xaxt = 'n', yaxt = 'n', legend = F, col = "darkgreen")
...
street_mask_rf <- mask(m_RF, dat_transformed)
street_mask_svm <- mask(m_SVM, dat_transformed)
