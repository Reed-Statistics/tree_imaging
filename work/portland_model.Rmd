...
portland_wgs84 <- spTransform(portland, CRS("+proj=utm +zone=10 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"))
...
freq(street_mask) # testing accuracy estimates for Western redcedars
# 34%
```
