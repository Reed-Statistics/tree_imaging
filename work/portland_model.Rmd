...
results_a <- predRaster(stack_a[[1:4]]) # svm more than 2 hrs, didn't finish
results_b <- predRaster(stack_b[[1:4]])
results_c <- predRaster(stack_c[[1:4]])
results_d <- predRaster(stack_d[[1:4]])
results_e <- predRaster(stack_e[[1:4]])
```
