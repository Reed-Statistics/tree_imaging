...
ndvi_mask_b <- mask(stack_b, ndvi_b, filename = "ndvi_mask_b.tif", overwrite = T)
ndvi_mask_c <- mask(stack_c, ndvi_c, filename = "ndvi_mask_c.tif", overwrite = T)
ndvi_mask_d <- mask(stack_d, ndvi_d, filename = "ndvi_mask_d.tif", overwrite = T)
ndvi_mask_e <- mask(stack_e, ndvi_e, filename = "ndvi_mask_e.tif", overwrite = T)
```
...
gi_mask_b <- mask(stack_b, gi_b, filename = "grass_mask_b.tif", overwrite = T)
gi_mask_c <- mask(stack_c, gi_c, filename = "grass_mask_c.tif", overwrite = T)
gi_mask_d <- mask(stack_d, gi_d, filename = "grass_mask_d.tif", overwrite = T)
gi_mask_e <- mask(stack_e, gi_e, filename = "grass_mask_e.tif", overwrite = T)
