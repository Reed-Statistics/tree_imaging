...
title: 'Statistical Learning Methods for Tree Classification using Remote Sensing Imagery'
...
abstract: |
  `r if(knitr:::is_latex_output()) paste(readLines("~/tree_imaging/index/prelims/00-abstract.Rmd"), collapse = '\n  ')`
