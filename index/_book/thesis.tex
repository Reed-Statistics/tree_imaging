...
\caption{\label{tab:resultsTest2RF}Western redcedar accuracy of 7 predictor RF (5 class) model on test data}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}}
\hline
  & Sensitivity & Specificity & Pos Pred Value & Neg Pred Value & Precision & Recall & F1 & Prevalence & Detection Rate & Detection Prevalence & Balanced Accuracy\\
\hline
Class: Broadleaf & NA & 0.37 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.63 & NA\\
\hline
Class: Douglas-Fir & NA & 0.92 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.08 & NA\\
\hline
Class: Giant Sequoia & NA & 0.96 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.04 & NA\\
\hline
Class: grass & NA & 0.97 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.03 & NA\\
\hline
Class: Western Redcedar & 0.22 & NA & NA & NA & 1 & 0.22 & 0.36 & 1 & 0.22 & 0.22 & NA\\
\hline
\end{tabular}}
\end{table}
\begin{table}[!h]

\caption{\label{tab:resultsTest2SVM}Western redcedar accuracy of Radial SVM (5 class) model on test data}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{l|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}|>{\raggedleft\arraybackslash}p{0.6in}}
\hline
  & Sensitivity & Specificity & Pos Pred Value & Neg Pred Value & Precision & Recall & F1 & Prevalence & Detection Rate & Detection Prevalence & Balanced Accuracy\\
\hline
Class: Broadleaf & NA & 0.19 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.81 & NA\\
\hline
Class: Douglas-Fir & NA & 0.97 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.03 & NA\\
\hline
Class: Giant Sequoia & NA & 0.99 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.01 & NA\\
\hline
Class: grass & NA & 0.97 & NA & NA & 0 & NA & NA & 0 & 0.00 & 0.03 & NA\\
\hline
Class: Western Redcedar & 0.11 & NA & NA & NA & 1 & 0.11 & 0.2 & 1 & 0.11 & 0.11 & NA\\
\hline
\end{tabular}}
\end{table}
