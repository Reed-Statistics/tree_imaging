...
\NormalTok{acpl <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\StringTok{"~/Documents/Fall_2020_Reed/Thesis/tree_canopy/acpl_polygon.shp"}\NormalTok{)}
\NormalTok{psme <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\StringTok{"~/Documents/Fall_2020_Reed/Thesis/tree_canopy/psme_polygon.shp"}\NormalTok{)}
\NormalTok{quru <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\StringTok{"~/Documents/Fall_2020_Reed/Thesis/tree_canopy/quru_polygon.shp"}\NormalTok{)}
\NormalTok{redcedar <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\StringTok{"~/Documents/Fall_2020_Reed/Thesis/tree_canopy/redwood_polygon.shp"}\NormalTok{)}
\NormalTok{segi <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\StringTok{"~/Documents/Fall_2020_Reed/Thesis/tree_canopy/segi_polygon.shp"}\NormalTok{)}
\NormalTok{acma <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\StringTok{"~/Documents/Fall_2020_Reed/Thesis/tree_canopy/acma_polygon.shp"}\NormalTok{)}
\NormalTok{grass <-}\StringTok{ }\KeywordTok{st_read}\NormalTok{(}\StringTok{"~/Documents/Fall_2020_Reed/Thesis/tree_canopy/grass_polygon.shp"}\NormalTok{)}
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Common_Name }\OperatorTok{%in%}\StringTok{ "Western Redcedar"} \OperatorTok{|}\StringTok{ }\NormalTok{Species }\OperatorTok{%in%}\StringTok{ }\KeywordTok{unique}\NormalTok{(pixels_data}\OperatorTok{$}\NormalTok{Species),}
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{filter}\NormalTok{(Cmmn_Nm }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Western Redcedar"}\NormalTok{, }\StringTok{"Bigleaf Maple"}\NormalTok{, }\StringTok{"Douglas-Fir"}\NormalTok{, }
                               \CommentTok{#"English Oak",}
...
\NormalTok{results_svm <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(svm1}\OperatorTok{$}\NormalTok{resample, }\DataTypeTok{Model =} \KeywordTok{rep}\NormalTok{(}\StringTok{"Linear, C = 7"}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{10}\NormalTok{),}
...
\NormalTok{                                 svm3}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{], }\StringTok{", degree ="}\NormalTok{, svm3}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{])),}
                     ...
                     \KeywordTok{cbind}\NormalTok{(svm2_center}\OperatorTok{$}\NormalTok{resample, }
                           ...
                           \DataTypeTok{Parameter =} \KeywordTok{paste}\NormalTok{(}\StringTok{"C ="}\NormalTok{, svm2_center}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{], }
                                 ...
                                 \KeywordTok{round}\NormalTok{(svm2_center}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{], }\DecValTok{4}\NormalTok{))),}
...
\NormalTok{                                 svm3_center}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{], }
                     ...
                     \KeywordTok{cbind}\NormalTok{(svm2_grouped}\OperatorTok{$}\NormalTok{resample, }
                           ...
                           \DataTypeTok{Parameter =} \KeywordTok{paste}\NormalTok{(}\StringTok{"C ="}\NormalTok{, svm2_grouped}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{], }
                                             \StringTok{"sigma ="}\NormalTok{,}
                                             \KeywordTok{round}\NormalTok{(svm2_grouped}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{], }\DecValTok{4}\NormalTok{))),}
                     \KeywordTok{cbind}\NormalTok{(svm3_grouped}\OperatorTok{$}\NormalTok{resample, }
                           ...
                           \DataTypeTok{Parameter =} \KeywordTok{paste}\NormalTok{(}\StringTok{"C ="}\NormalTok{, svm3_grouped}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{], }
                                             \StringTok{", scale ="}\NormalTok{, }
\NormalTok{                                 svm3_grouped}\OperatorTok{$}\NormalTok{bestTune[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{], }
...
\CommentTok{# merge rasters into one for plotting}
\NormalTok{r_list_RF <-}\StringTok{ }\KeywordTok{list}\NormalTok{(results_a[[}\DecValTok{1}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{, results_b[[}\DecValTok{1}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{, results_c[[}\DecValTok{1}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{,}
\NormalTok{                  results_d[[}\DecValTok{1}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{, results_e[[}\DecValTok{1}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{)}
\NormalTok{r_list_SVM <-}\StringTok{ }\KeywordTok{list}\NormalTok{(results_a[[}\DecValTok{2}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{, results_b[[}\DecValTok{2}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{, results_c[[}\DecValTok{2}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{,}
\NormalTok{                  results_d[[}\DecValTok{2}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{, results_e[[}\DecValTok{2}\NormalTok{]] }\OperatorTok{==}\StringTok{ }\DecValTok{7}\NormalTok{)}
\NormalTok{m_RF <-}\StringTok{ }\KeywordTok{do.call}\NormalTok{(merge, r_list_RF)}
\NormalTok{m_SVM <-}\StringTok{ }\KeywordTok{do.call}\NormalTok{(merge, r_list_SVM)}

\CommentTok{# compare rasters}
\NormalTok{r_matches <-}\StringTok{ }\NormalTok{m_RF }\OperatorTok{==}\StringTok{ }\NormalTok{m_SVM}
\KeywordTok{freq}\NormalTok{(r_matches)}
...
\CommentTok{# (r_matches == 1)/((r_matches == 0) + (r_matches == 1)) percentage in common: 83%}
\KeywordTok{plot}\NormalTok{(r_matches }\OperatorTok{==}\StringTok{ }\DecValTok{1}\NormalTok{, }\DataTypeTok{main =} \StringTok{"RF C = 5 and SVM C = 5 Predictions Comparisons"}\NormalTok{,}
     \DataTypeTok{labels =}\NormalTok{ F, }\DataTypeTok{xaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{yaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{legend =}\NormalTok{ F, }\DataTypeTok{col =} \StringTok{"lightgreen"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(r_matches }\OperatorTok{==}\StringTok{ }\DecValTok{0}\NormalTok{, }\DataTypeTok{col =} \StringTok{"maroon"}\NormalTok{, }\DataTypeTok{labels =}\NormalTok{ F, }\DataTypeTok{xaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{yaxt =} \StringTok{'n'}\NormalTok{,}
     \DataTypeTok{legend =}\NormalTok{ F, }\DataTypeTok{add =}\NormalTok{ T)}
...
\NormalTok{portland_wgs84 <-}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(portland, }
                              \KeywordTok{CRS}\NormalTok{(}\StringTok{"+proj=utm +zone=10 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"}\NormalTok{))}

\CommentTok{# plot predictions}
\KeywordTok{plot}\NormalTok{(m_RF, }\DataTypeTok{main =} \StringTok{"RF Western Redcedar Predictions"}\NormalTok{, }
...
\KeywordTok{plot}\NormalTok{(m_SVM, }\DataTypeTok{main =} \StringTok{"SVM Western Redcedar Predictions"}\NormalTok{, }
     \DataTypeTok{labels =}\NormalTok{ F, }\DataTypeTok{xaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{yaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{legend =}\NormalTok{ F, }\DataTypeTok{col =} \StringTok{"darkgreen"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(portland_wgs84, }\DataTypeTok{add =}\NormalTok{ T)}
...
\NormalTok{dat_transformed <-}\StringTok{ }\KeywordTok{spTransform}\NormalTok{(redcedar_dat, }\KeywordTok{CRS}\NormalTok{(}\StringTok{"+proj=utm +zone=10 +ellps=WGS84 +datum=WGS84 +units=m +no_defs"}\NormalTok{))}

\CommentTok{# plot pdxTrees with predictions}
\NormalTok{p1 <-}\StringTok{ }\KeywordTok{plot}\NormalTok{(m_RF, }\DataTypeTok{main =} \StringTok{"RF C = 5 with pdxTrees"}\NormalTok{, }
     \DataTypeTok{labels =}\NormalTok{ F, }\DataTypeTok{xaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{yaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{legend =}\NormalTok{ F, }\DataTypeTok{col =} \StringTok{"darkgreen"}\NormalTok{)}
...
\KeywordTok{plot}\NormalTok{(m_SVM, }\DataTypeTok{main =} \StringTok{"SVM C = 5 with pdxTrees"}\NormalTok{, }
     \DataTypeTok{labels =}\NormalTok{ F, }\DataTypeTok{xaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{yaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{legend =}\NormalTok{ F, }\DataTypeTok{col =} \StringTok{"darkgreen"}\NormalTok{)}
\KeywordTok{plot}\NormalTok{(dat_transformed, }\DataTypeTok{col =} \KeywordTok{rgb}\NormalTok{(}\DataTypeTok{red =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{green =} \FloatTok{0.2}\NormalTok{, }\DataTypeTok{blue =} \FloatTok{1.0}\NormalTok{, }\DataTypeTok{alpha =} \FloatTok{0.2}\NormalTok{), }
     \DataTypeTok{cex =} \FloatTok{.2}\NormalTok{, }\DataTypeTok{add =}\NormalTok{ T)}
\KeywordTok{plot}\NormalTok{(portland_wgs84, }\DataTypeTok{add =}\NormalTok{ T)}
...
\NormalTok{street_mask <-}\StringTok{ }\KeywordTok{mask}\NormalTok{(m_RF, dat_transformed)}
\NormalTok{street_mask_group <-}\StringTok{ }\KeywordTok{mask}\NormalTok{(m_SVM, dat_transformed)}
\KeywordTok{freq}\NormalTok{(street_mask)[}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{]}\OperatorTok{/}\KeywordTok{nrow}\NormalTok{(dat_transformed) }\CommentTok{# estimates for Western redcedars}
\CommentTok{# 52%}
\KeywordTok{freq}\NormalTok{(street_mask_group)[}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{]}\OperatorTok{/}\KeywordTok{nrow}\NormalTok{(dat_transformed) }\CommentTok{# estimates for Western redcedars}
\CommentTok{# 66%}

\CommentTok{# smaller visualization around Reed}
\NormalTok{reed_stack <-}\StringTok{ }\KeywordTok{crop}\NormalTok{(m_RF, }\KeywordTok{extent}\NormalTok{(}\DecValTok{525000}\NormalTok{, }\DecValTok{530000}\NormalTok{, }\DecValTok{5035000}\NormalTok{, }\DecValTok{5040000}\NormalTok{))}
\NormalTok{trees_reed <-}\StringTok{ }\KeywordTok{crop}\NormalTok{(dat_transformed, }\KeywordTok{extent}\NormalTok{(}\DecValTok{525000}\NormalTok{, }\DecValTok{530000}\NormalTok{, }\DecValTok{5035000}\NormalTok{, }\DecValTok{5040000}\NormalTok{))}

\CommentTok{# Portland with extent box}
\KeywordTok{plot}\NormalTok{(m_RF, }\DataTypeTok{main =} \StringTok{"RF C = 7 with pdxTrees"}\NormalTok{, }
     \DataTypeTok{labels =}\NormalTok{ F, }\DataTypeTok{xaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{yaxt =} \StringTok{'n'}\NormalTok{, }\DataTypeTok{legend =}\NormalTok{ F, }\DataTypeTok{col =} \StringTok{"darkgreen"}\NormalTok{)}
