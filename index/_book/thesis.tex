...
{\centering \includegraphics[width=6.94in,scale=0.2]{figure/polyimage} 
...
{\centering \includegraphics[width=6.94in,scale=0.2]{figure/redcedar} 
...
A second mask is applied to the raster image that contains only the vegetation pixels to distinguish tree pixels from grass pixels. Inspired by (Qian, Zhou, Nytch, Han, \& Li, 2020), the\ldots{}
\begin{figure}
