...
\end{figure}
In comparing the SVM model results to the RF results, 80\% of the pixel predictions were the same predictions.
...
Comparison of svm versus random forest, 5 class versus 7 classes
Comparison of data to Fricker (1m v 3m), best model to Fricker
Key takeaways: benefit of 4 band data is lighter computations
Methods of improvement: higher resolution and more bands
