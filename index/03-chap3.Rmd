...
```{r rf7, results="asis", echo=FALSE, fig.cap='Accuracy of the 7 predictor trained random forest model for different mtry numbers over 10-fold cross-validation.', out.width='70%', fig.align='center'}
...
```{r rf8, results="asis", echo=FALSE, fig.cap='Accuracy of the 8 predictor trained random forest model for different mtry numbers over 10-fold cross-validation.', out.width='70%', fig.align='center'}
...
```{r svm2, results="asis", echo=FALSE, fig.cap="Comparison of accuracy results from different cost parameters with sigma held constant at 0.25 for radial basis function kernel.", out.width='70%', fig.align='center'}
...
```{r svm3, results="asis", echo=FALSE, fig.cap="Comparison of accuracy results from different cost parameters with scale ranging from 0.001 to 0.1, C from 0.25 to 1, and degree from 1 to 3 for polynomial SVM.", out.width='70%', fig.align='center'}
...
test_results <- read.csv('~/tree_imaging/test_results.csv', check.names = F)
...
knitr::kable(results_tab, "latex", caption = "Overall accuracy of 8 predictor RF model compared to Radial SVM model on test data")
knitr::kable(results_redcedar_tab, "latex", caption = "Western redcedar accuracy of 8 predictor RF model on test data")
```
...
poly_test_rf <- read.csv('~/tree_imaging/poly_test_rf.csv', check.names = F)
poly_test_svm <- read.csv('~/tree_imaging/poly_test_svm.csv', check.names = F)
...
knitr::kable(poly_test_rf, "latex", caption = "Accuracy of 8 predictor random forest model for polygons in test data. A \'correct\' prediction is considered to be a polygon with more than half of the pixels correctly classified.")
knitr::kable(poly_test_svm, "latex", caption = "Accuracy of radial support vector machine model for polygons in test data. A \'correct\' prediction is considered to be a polygon with more than half of the pixels correctly classified.")
```
