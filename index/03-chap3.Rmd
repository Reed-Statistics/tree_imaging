...
```{r rf8c, results="asis", echo=FALSE, fig.cap='Accuracy of the 8 predictor RF Model on point pixels data for different mtry numbers over 10-fold cross-validation on 7 class and 5 class training data. (P = Predictors, C = Classes)', out.width='90%', fig.align='center'}
